...
- The service is registered only on the legacy/operator listener. Privacy
  listeners continue to expose only their policy-filtered `CompactTxStreamer`
  routes and `PrivacyProfileService`.
